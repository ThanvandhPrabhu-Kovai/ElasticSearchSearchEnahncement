    ...
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            var response = await elasticSearch.ComplexSearchAsync(
                elasticClient,
                model);
            //var response0 = await elasticSearch.ComplexSearchAsync(
            //    elasticClient,
            //    searchFieldsCustomers);
            //var response1 = await elasticSearch.ComplexSearchAsync(
            //    elasticClient,
            //    searchFieldsContacts);
            //var response2 = await elasticSearch.ComplexSearchAsync(
            //    elasticClient,
            //    searchFieldsOpps);
